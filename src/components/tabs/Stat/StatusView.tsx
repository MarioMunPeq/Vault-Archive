...
const OVERHANG =
  HEAD_NECK.y - Math.min(...BODY_NECK_SOCKETS.map((s) => s.y)) + 1
const FIGURE = { w: BODY_CANVAS.w, h: OVERHANG + BODY_CANVAS.h }
...
const GUN_ICON = `
<svg fill="#0daa23" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
const ARMOR_ICON = `
<svg fill="#0daa23" width="800px" height="800px" viewBox="0 0 32 32" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:serif="http://www.serif.com/" xmlns:xlink="http://www.w3.org/1999/xlink">
...
const RAD_ICON = `
<svg fill="#0daa23" width="800px" height="800px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
